...
Description             : Textures brightmaps for Doom, Doom II, Final Doom,
                          Heretic and Hexen. To be used with GZDoom only. 
...
Game                    : Doom I/II, Final Doom, Heretic, Hexen
Map #                   : None
Single Player           : No
...
May Not Run With        : Vanilla doom.exe, doom2.exe, heretic.exe, hexen.exe
Tested With             : GZDoom
...
[DOOM/DOOM2] Deactivated certain flat brightmaps to improve dark level areas (CEIL1_2, CEIL1_3,
             CEIL3_4, CEIL3_6, FLAT2, FLAT17, FLOOR1_7, TLITE6_1, TLITE6_5 and GRNLITE1)
