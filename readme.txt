...
==================================================================================
Title                   : Brightmaps Collection for GZDoom v1.64
Filename                : brightmaps_plus.pk3
Release date            : 06/08/2019
Author                  : NightFright

Description             : Textures/sprites brightmaps for Doom, Doom II, Final Doom,
                          ...
                          - It is assumed you use the spritefixes for Doom and 
                            ...
                            hrspfx10.wad). 
                          - By editing the definitions inside of the PK3 file, you
                            can switch to vanilla sprite support and deactivate
                            brightmaps for textures (which are used by default).
                          - As long as you use the spritefix definitions, avoid 
                            loading these brightmaps with Doom/Heretic addons
                            that come with customized sprites. Textures won't matter.
...
Credits                 : Based on original graphics by
                          ...
                          - NightFright (Doom spritefix sprites)
